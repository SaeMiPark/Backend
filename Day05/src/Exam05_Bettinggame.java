	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			try {
				...
				if(menu==1) {
					while(true) {
						...
						try {
							...
							if(select!=1&&select!=2&&select!=3) {
								System.out.println("말의 번호를 다시 확인하세요.");
							}
							System.out.println(select+"말을 선택하셨습니다.");
							break;
						}catch(Exception e) {
							System.out.println("말을 다시 입력하세요.");
						}
					...
					while(true) {
						...
						try {
							...
							System.out.println("배팅 금액을 다시 입력하세요.");
						}
				...
				System.out.println("menu는 문자가 아닌 숫자를 입력하세요.");
			}
